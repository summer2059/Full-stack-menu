            ...
            <div class="card-body custom-input">
                <div class="row g-3">
                    ...
                    <div class="form-group{{ $errors->has('keywords') ? ' has-error' : '' }}">
                        <label for="keywords" class="col-sm-2 control-label">Footer company name *</label>
                        <div class="col-sm-10">
                            <textarea name="keywords" id="keywords" class="form-control" rows="4">{{ getConfiguration('keywords') }}</textarea>
