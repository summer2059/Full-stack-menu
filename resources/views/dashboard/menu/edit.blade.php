        ...
        <div class="card-body">
            <form action="{{ route('menu.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" id="titleInput" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $data->title) }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="menu_category_id" id="menu_category_id" class="form-select @error('menu_category_id') is-invalid @enderror">
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}" {{ old('menu_category_id', $data->menu_category_id) == $category->id ? 'selected' : '' }}>
                                {{ $category->title }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    @if($data->image)
                        <img id="imagePreview" src="{{ asset('uploads/images/' . $data->image) }}" alt="Current Image" class="img-fluid rounded border" style="max-width: 50%;">
                    @else
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="price" id="price" step="0.01" min="0" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $data->price) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="rating" id="rating" step="0.1" min="1" max="5" class="form-control @error('rating') is-invalid @enderror" value="{{ old('rating', $data->rating) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="priority" id="priority" class="form-control @error('priority') is-invalid @enderror" value="{{ old('priority', $data->priority) }}">
