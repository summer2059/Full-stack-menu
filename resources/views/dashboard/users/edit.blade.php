                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <div class="input-group">
                                <input type="password" name="password" id="password"
                                       class="form-control @error('password') is-invalid @enderror" autocomplete="new-password" placeholder="Leave blank to keep current">
...
<script>
    ...
    function loadPermissions(role) {
        ...
        .then(data => {
            ...
            // Current user's permissions to pre-check boxes
            const userPermissions = @json($user->getPermissionNames());
    ...
    // On load, load permissions for current role
